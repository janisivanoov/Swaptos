    ...
    <>
      <div className="bg-gray_900 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-end justify-start pb-[135px] w-[100%]">
          ...
          <div className="font-poppins md:h-[1138px] h-[1222px] sm:h-[1716px] md:px-[20px] sm:px-[20px] relative md:w-[100%] sm:w-[100%] w-[95%]">
            <div
            ...
            <div className="absolute bottom-[0] flex flex-col font-poppins items-center justify-start left-[12%] w-[71%]">
            ...
            <Text
              className="absolute bg-clip-text bg-gradient4  font-bold left-[0] text-left text-transparent top-[36%] w-[auto]"
              variant="body7"
            >
...
export default PreLaunchBlackPage;
