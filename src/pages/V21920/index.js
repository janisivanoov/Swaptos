...
const V21920Page = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-inter gap-[111px] md:gap-[40px] sm:gap-[40px] items-center justify-start mx-[auto] w-[100%]">
        <div
          className="bg-cover bg-no-repeat h-[6210px] md:h-[6698px] sm:h-[7340px] pb-[49px] relative w-[100%]"
          style={{ backgroundImage: "url('images/img_group115.png')" }}
        >
          <div className="h-[6160px] md:h-[6698px] sm:h-[7340px] m-[auto] w-[100%]">
            <div className="h-[6160px] md:h-[6698px] sm:h-[7340px] m-[auto] w-[100%]">
              <div className="flex flex-col md:gap-[40px] sm:gap-[40px] gap-[76px] h-[100%] items-center justify-start m-[auto] w-[100%]">
                <header className="flex items-center justify-center w-[100%]">
                  <div className="bg-gradient11  flex flex-1 flex-col items-center justify-center w-[100%]">
                    <div className="flex md:flex-col sm:flex-col flex-row gap-[213px] md:gap-[40px] sm:gap-[40px] items-center justify-center p-[28px] sm:px-[20px] w-[100%]">
                      <div className="flex md:flex-1 sm:flex-1 flex-col font-poppins items-center justify-start md:ml-[0] sm:ml-[0] ml-[342px] md:mt-[0] sm:mt-[0] mt-[3px] md:w-[100%] sm:w-[100%] w-[43%]">
                      ...
                      <Button
                        className="cursor-pointer font-bold font-inter leading-[normal] min-w-[175px] mr-[342px] text-[16px] text-center text-white_A700 w-[auto]"
                ...
                <div className="h-[5973px] md:h-[6547px] sm:h-[7189px] relative md:w-[100%] sm:w-[100%] w-[70%]">
                  <div className="flex flex-col font-poppins items-center justify-start mb-[-65px] mx-[auto] w-[89%] z-[1]">
                    <Button
                      className="cursor-pointer font-bold leading-[normal] min-w-[396px] sm:text-[21px] md:text-[23px] text-[25px] text-center text-purple_A100 w-[auto]"
                      shape="RoundedBorder23"
                      size="4xl"
                    ...
                    <Text
                      className="leading-[70.00px] mt-[20px] text-center text-gray_900 w-[100%]"
                      as="h3"
                      variant="h3"
                    >
                    ...
                    <Text
                      className="font-bold text-center text-gray_600 sm:w-[100%] w-[88%]"
                      variant="body4"
                    >
                  ...
                  <div className="flex flex-col gap-[145px] md:gap-[40px] sm:gap-[40px] items-center justify-start mt-[auto] mx-[auto] w-[100%]">
                    <div className="flex flex-col items-center justify-start w-[100%]">
                        ...
                        <div className="flex flex-col items-center justify-start w-[100%]">
                          <div className="flex flex-col gap-[20px] items-center justify-start w-[100%]">
                            <div className="h-[1019px] md:h-[634px] sm:h-[634px] relative w-[100%]">
                              <div
                                className="absolute bg-cover bg-no-repeat flex flex-col items-end justify-start left-[3%] p-[113px] sm:px-[20px] md:px-[40px] top-[0] w-[87%]"
                                style={{
                                  backgroundImage:
                                    "url('images/img_vector_purple_a100_634x1020.svg')",
                                }}
                              >
                                <Button
                                  className="cursor-pointer font-bold leading-[normal] mb-[361px] mr-[260px] text-[16px] text-center text-white_A700 w-[175px]"
                                  shape="RoundedBorder23"
                                  size="6xl"
                                  variant="GradientBlueA200DeeppurpleA700"
                                >
                              ...
                              <div className="absolute bottom-[30%] flex flex-col font-poppins items-center justify-start pt-[6px] right-[0] w-[33%]">
                                  ...
                                  <div className="h-[280px] md:h-[auto] sm:h-[auto] m-[auto] w-[100%]">
                                    ...
                                    <div className="absolute md:h-[71px] sm:h-[71px] h-[72px] left-[4%] top-[9%] w-[65%]">
                                      ...
                                      <div className="absolute flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] pl-[8px] py-[8px] w-[98%]">
                                        <Text
                                          className="font-medium mb-[2px] mt-[35px] text-black_900 text-left w-[auto]"
                                          variant="body12"
                                        >
                              ...
                              <div className="absolute bottom-[0] flex flex-col font-poppins items-center justify-start right-[0] w-[67%]">
                                <div className="bg-gray_50_b2 flex flex-col items-center justify-end sm:pl-[20px] pl-[24px] pt-[24px] rounded-radius20 shadow-bs2 w-[100%]">
                                  <div className="flex flex-col items-start justify-start mt-[4px] w-[100%]">
                                    <div className="flex flex-row sm:gap-[40px] items-start justify-between md:w-[100%] sm:w-[100%] w-[96%]">
                                      <Text
                                        className="font-bold mt-[11px] text-black_900 text-left w-[auto]"
                                        variant="body4"
                                      >
                                    ...
                                    <div className="md:h-[164px] sm:h-[164px] h-[212px] relative w-[100%]">
                                      <Text
                                        className="absolute font-medium left-[0] text-black_900 text-left top-[0] sm:w-[100%] w-[36%]"
                                        variant="body12"
                                      >
                                        <span className="text-black_900 text-[16px] font-poppins">
                                          See{" "}
                                      ...
                                      <div className="absolute bg-gray_50_b3 bottom-[0] flex flex-col items-end justify-start sm:pl-[20px] pl-[23px] right-[0] w-[73%]">
                                        <Img
                              ...
                              <div className="absolute bg-white_A700 bottom-[29%] flex flex-col font-poppins inset-x-[0] items-center justify-start mx-[auto] p-[20px] rounded-radius20 shadow-bs2 w-[33%]">
                                <div className="flex flex-col items-start justify-start mb-[18px] mt-[7px] md:w-[100%] sm:w-[100%] w-[96%]">
                                  <div className="flex flex-row items-end justify-between md:ml-[0] sm:ml-[0] ml-[4px] md:w-[100%] sm:w-[100%] w-[99%]">
                                    <Text
                                      className="font-bold mt-[5px] text-black_900 text-left w-[auto]"
                                      variant="body4"
                                    >
                                      Mystery Pool
                                    </Text>
                                  ...
                                  <Text
                                    className="font-medium md:ml-[0] sm:ml-[0] ml-[4px] mt-[3px] text-black_900 text-left w-[auto]"
                                    variant="body12"
                                  >
                                  ...
                                  <div className="h-[110px] md:h-[159px] sm:h-[159px] mt-[49px] relative md:w-[100%] sm:w-[100%] w-[97%]">
                                    ...
                                    <Img
                                      src="images/img_illustration_teal_400.png"
                              ...
                              <div className="absolute bottom-[0] flex flex-col font-poppins items-center justify-start left-[0] w-[33%]">
                                <div className="flex flex-col items-center justify-start w-[100%]">
                                    ...
                                    <div className="flex md:h-[409px] sm:h-[409px] h-[518px] justify-end relative sm:w-[100%] w-[95%]">
                                      <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-[auto] pt-[8px] px-[8px] top-[0] w-[100%]">
                                        <div className="flex flex-col items-center justify-start mt-[2px] pb-[93px] w-[100%]">
                                          ...
                                          <Text
                                            className="font-medium text-black_900 text-left w-[100%]"
                                            variant="body12"
                                          >
                                      ...
                                      <div className="absolute bottom-[0] flex flex-row inset-x-[0] items-start justify-between mx-[auto] w-[87%]">
                                        ...
                                        <Text
                                          className="font-bold mt-[34px] text-black_900 text-center w-[auto]"
                                          variant="body4"
                                        >
                                          Trade  your crypto
                                        </Text>
                            ...
                            <div className="flex md:flex-col sm:flex-col flex-row font-poppins gap-[20px] items-center justify-between w-[100%]">
                              <div
                              ...
                              >
                                ...
                                <div className="absolute bottom-[8%] md:h-[127px] sm:h-[127px] h-[188px] right-[8%] sm:w-[100%] w-[78%]">
                                  <Text
                                    className="absolute bottom-[0] right-[0] text-black_900 text-left w-[auto]"
                                    as="h5"
                                    variant="h5"
                                  >
                                    <span className="text-black_900 text-[16px] font-poppins font-bold">
                                      up to
                                    </span>
                                    <span className="sm:text-[36px] md:text-[38px] text-black_900 text-[40px] font-poppins font-bold">
                                      {" "}
                                    </span>
                                  ...
                                  <div className="absolute md:h-[127px] sm:h-[127px] h-[172px] left-[0] top-[0] sm:w-[100%] w-[89%]">
                                    ...
                                    <div className="absolute bg-gray_900 flex flex-col items-center justify-start p-[16px] right-[0] rounded-radius24 top-[0] w-[34%]">
                                      <div
                                        ...
                                        name="Group237"
                                      >
                                        <div className="w-full h-full absolute bg-gray_801 rounded-[7px]"></div>
                                        <div
                                          className="h-full absolute bg-gradient-to-r from-[#fe80db] to-[#cc9b1dff]  rounded-[7px]"
                                          style={{ width: "67%" }}
                                        ></div>
                                      </div>
                                    </div>
                                    <div className="absolute bg-gray_900 flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] p-[9px] rounded-radius24 w-[34%]">
                                      <Button
                                        ...
                                        size="mdIcn"
                                        variant="icbGradientPurpleA100PurpleA700cc"
                                      >
                                        <Img
                              ...
                              <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-end pt-[24px] sm:px-[20px] px-[24px] rounded-radius20 shadow-bs2 md:w-[100%] sm:w-[100%] w-[auto]">
                                <div className="flex flex-col items-start justify-start mt-[4px] md:w-[100%] sm:w-[100%] w-[98%]">
                                  <div className="flex flex-row sm:gap-[40px] items-start justify-between w-[100%]">
                                    <Text
                                      className="font-bold mt-[4px] text-black_900 text-left w-[auto]"
                                      variant="body4"
                                    >
                                      Referral program
                                    </Text>
                            ...
                            <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                              ...
                              >
                                <div className="bg-white_A700 flex flex-col h-[180px] items-center justify-start sm:ml-[0] p-[12px] rounded-radius20 shadow-bs2 w-[100%]">
                                  ...
                                  <Text
                                    className="font-bold font-poppins mt-[10px] text-black_900 text-left w-[auto]"
                                    variant="body9"
                                  >
                                    Chainlink
                                  </Text>
                                  <Text
                                    className="font-inter font-medium mb-[6px] mt-[12px] text-black_900 text-left w-[auto]"
                                    variant="body17"
                                  >
                                    (LINK)
                                  </Text>
                                ...
                                <div className="bg-white_A700 flex flex-col h-[180px] items-center justify-start sm:ml-[0] p-[12px] rounded-radius20 shadow-bs2 w-[100%]">
                                  ...
                                  <Text
                                    className="font-bold font-poppins mt-[11px] text-black_900 text-left w-[auto]"
                                    variant="body9"
                                  >
                                    Monero
                                  </Text>
                                  <Text
                                    className="font-inter font-medium mb-[6px] mt-[11px] text-black_900 text-left w-[auto]"
                                    variant="body17"
                                  >
                                    (XMR)
                                  </Text>
                      ...
                      <div className="flex flex-col font-poppins items-center justify-start mt-[885px] w-[100%]">
                      ...
                      <div className="font-poppins h-[678px] md:h-[830px] sm:h-[998px] mt-[9px] relative md:w-[100%] sm:w-[100%] w-[89%]">
                          ...
                          <div className="flex md:flex-1 sm:flex-1 flex-col gap-[20px] items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                            ...
                            <div className="bg-white_A700 flex flex-col justify-end pt-[35px] sm:px-[20px] px-[35px] shadow-bs2 w-[100%]">
                              ...
                              <div className="flex flex-col gap-[26px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[142px] mr-[198px] mt-[59px] md:w-[100%] sm:w-[100%] w-[34%]">
                                ...
                                <Line className="bg-black_900 h-[2px] w-[28%]" />
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="font-poppins h-[1444px] md:h-[1529px] sm:h-[1605px] relative w-[100%]">
                        ...
                        <div className="flex flex-col md:gap-[40px] sm:gap-[40px] gap-[97px] items-center justify-start w-[100%]">
                          <div className="flex flex-col gap-[131px] md:gap-[40px] sm:gap-[40px] justify-start w-[100%]">
                            ...
                            <div className="flex flex-col items-center justify-start pr-[12px] py-[12px] w-[100%]">
                              <div className="my-[26px] overflow-x-auto w-[100%]">
                                <div className="md:h-[691px] sm:h-[691px] h-[694px] relative w-[100%]">
                                  <div className="absolute flex flex-col h-[max-content] inset-y-[0] items-center justify-start left-[0] my-[auto] w-[99%]">
                                    <div className="md:h-[691px] sm:h-[691px] h-[694px] relative w-[100%]">
                                      <div className="absolute bg-white_A700 flex flex-col h-[max-content] inset-y-[0] items-start justify-start my-[auto] p-[29px] sm:px-[20px] right-[2%] rounded-radius40 shadow-bs2 w-[93%]">
                                        <Text
                                      ...
                                      <div className="absolute flex sm:flex-col flex-row font-inter sm:gap-[20px] inset-x-[0] items-center justify-start mx-[auto] px-[130px] sm:px-[20px] md:px-[40px] top-[21%] w-[100%]">
                                        <Text
                                          className="font-bold text-gray_600 text-left w-[auto]"
                                          variant="body12"
                                        >
                                  ...
                                  <div className="absolute bottom-[0] font-inter md:h-[601px] sm:h-[601px] h-[626px] inset-x-[0] mx-[auto] p-[52px] sm:px-[20px] md:px-[40px] w-[100%]">
                                    <div className="flex sm:flex-col flex-row gap-[203px] sm:gap-[40px] h-[100%] items-center justify-start ml-[78px] mt-[65px] pr-[5px] py-[5px] w-[76%]">
                                      <Text
                                    ...
                                    <div className="absolute bottom-[0] h-[457px] md:h-[601px] sm:h-[601px] left-[10%] md:w-[100%] sm:w-[100%] w-[1014px]">
                                  ...
                                  <div className="flex sm:flex-1 flex-col gap-[15px] items-start justify-start sm:w-[100%] w-[auto]">
                                    <div className="flex sm:flex-col flex-row gap-[18px] items-center justify-start w-[100%]">
                                      ...
                                      >
                                        ...
                                        >
                                          <Img
                                            src="images/img_refresh_orange_a200_40x40.svg"
                                            className=""
                                            alt="refresh"
                                          />
                                        </Button>
              ...
              <div className="absolute flex flex-col font-poppins items-center justify-start right-[19%] top-[37%] w-[50%]">
                <div className="flex flex-col items-center justify-start w-[100%]">
                  <div className="flex flex-col gap-[40px] justify-start w-[100%]">
                    ...
                    <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-end ml-[auto] md:w-[100%] sm:w-[100%] w-[82%]">
                      <div className="bg-white_A700 flex flex-col items-start justify-start p-[27px] sm:px-[20px] rounded-radius20 shadow-bs2 md:w-[100%] sm:w-[100%] w-[49%]">
                        ...
                        <Text
                          className="md:ml-[0] sm:ml-[0] ml-[29px] mt-[113px] text-black_900 text-left w-[auto]"
                          as="h6"
                          variant="h6"
                        >
                          <span className="text-black_900 text-[20px] font-poppins font-bold">
                            up to
                          </span>
                          <span className="sm:text-[21px] md:text-[23px] text-black_900 text-[25px] font-poppins font-bold">
                            {" "}
                          </span>
                          <span className="sm:text-[36px] md:text-[38px] text-purple_A100 text-[40px] font-poppins font-bold">
                            400% APY
                      ...
                      <div className="flex flex-col gap-[20px] items-center justify-start md:w-[100%] sm:w-[100%] w-[49%]">
                          ...
                          <div className="flex flex-col gap-[49px] justify-start mb-[3px] md:ml-[0] sm:ml-[0] ml-[3px] md:w-[100%] sm:w-[100%] w-[81%]">
                            ...
                            <div className="flex flex-row gap-[6px] items-center justify-end ml-[auto] md:w-[100%] sm:w-[100%] w-[80%]">
                              ...
                              <div className="flex flex-col gap-[34px] items-center justify-start w-[59%]">
                                ...
                                <div className="bg-white_A700 flex flex-col h-[38px] md:h-[auto] sm:h-[auto] items-center justify-center px-[6px] py-[3px] rounded-radius19 shadow-bs w-[122px]">
                        ...
                        <div className="bg-white_A700 flex flex-col md:gap-[40px] sm:gap-[40px] gap-[81px] items-center justify-start p-[24px] sm:px-[20px] rounded-radius20 shadow-bs2 w-[100%]">
                          <Text
                            className="font-bold text-gray_900 text-left w-[auto]"
                            variant="body4"
                          >
                          ...
                          <div className="flex flex-row items-start justify-start mb-[25px] w-[auto]">
                            ...
                            <div className="md:h-[116px] sm:h-[116px] h-[118px] px-[7px] relative w-[50%]">
                              <div className="absolute bg-white_A700 border border-gray_600_4c border-solid flex flex-col h-[max-content] inset-[0] items-start justify-center m-[auto] p-[10px] rounded-radius15 w-[84%]">
                                <Text
                                  className="mb-[71px] mt-[7px] text-gray_900 text-left w-[auto]"
                                  variant="body8"
                                >
                                  0.01%
                                </Text>
                              ...
                              <Text
                                className="absolute bottom-[19%] font-medium right-[6%] text-gray_900 text-left sm:w-[100%] w-[78%]"
                                variant="body17"
                              >
            ...
            <div className="absolute flex flex-col font-poppins gap-[1628px] md:gap-[40px] sm:gap-[40px] inset-x-[0] justify-start mx-[auto] top-[1%] w-[65%]">
              <div className="flex flex-col md:gap-[40px] sm:gap-[40px] gap-[527px] justify-start w-[100%]">
                <div className="flex flex-col items-center justify-start md:ml-[0] sm:ml-[0] ml-[382px] md:w-[100%] sm:w-[100%] w-[7%]">
              ...
              <div className="bg-white_A700 flex flex-col items-start justify-start md:ml-[0] sm:ml-[0] ml-[25px] mr-[827px] p-[9px] rounded-radius20 shadow-bs2 md:w-[100%] sm:w-[100%] w-[31%]">
                <Text
          ...
          <Img
            ...
            className="absolute h-[20px] left-[40%] top-[2%] w-[auto]"
            alt="cursor"
          />
        </div>
        <footer className="bg-gray_900 flex font-poppins items-center justify-center w-[100%]">
          <div className="flex flex-col items-center justify-center mb-[43px] mt-[46px] mx-[auto] w-[62%]">
