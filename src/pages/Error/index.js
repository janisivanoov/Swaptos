  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col items-center justify-end mx-[auto] w-[100%]">
        ...
        <div className="flex flex-col items-center justify-start mt-[133px] md:px-[20px] sm:px-[20px] md:w-[100%] sm:w-[100%] w-[16%]">
          <Text
          ...
          <Text
            className="font-medium font-poppins mt-[37px] text-gray_900 text-left w-[auto]"
            variant="body4"
          >
            Page not found
          </Text>
          <Button
            className="cursor-pointer font-bold font-inter leading-[normal] min-w-[175px] mt-[40px] text-[16px] text-center text-white_A700 w-[auto]"
            shape="RoundedBorder23"
            size="6xl"
            variant="GradientBlueA200DeeppurpleA700"
          >
        ...
        <Img
          ...
          className="h-[822px] mt-[2562px] w-[auto]"
          alt="05Freepools"
        />
      </div>
    </>
