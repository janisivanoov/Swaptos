...
const ExtraBoostpagewithmorPage = () => {
  ...
  return (
    <>
      <div className="font-poppins h-[5041px] mx-[auto] relative w-[100%]">
        <div className="absolute md:h-[4236px] sm:h-[4536px] h-[5041px] inset-[0] justify-center m-[auto] w-[100%]">
          <div className="md:h-[4236px] sm:h-[4536px] h-[5041px] m-[auto] w-[100%]">
            <div className="md:h-[4236px] sm:h-[4536px] h-[5041px] m-[auto] w-[100%]">
              <div className="bg-white_A700 flex flex-col h-[100%] items-center justify-start m-[auto] pb-[2645px] w-[100%]">
            ...
            <div className="absolute flex flex-col gap-[57px] inset-x-[0] items-center justify-start mx-[auto] pb-[564px] top-[11%] w-[100%]">
              <div className="sm:h-[1058px] h-[575px] md:h-[694px] relative w-[100%]">
                <div
                ...
                >
                  <div className="flex flex-col items-center justify-start mt-[442px] md:w-[100%] sm:w-[100%] w-[98%]">
                ...
                <div className="absolute sm:h-[1058px] h-[216px] md:h-[496px] inset-x-[0] mx-[auto] top-[22%] w-[100%]">
                  ...
                  <div className="absolute flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] w-[78%]">
                    <div className="flex flex-col gap-[14px] items-center justify-start w-[100%]">
                      ...
                      >
                        ...
                        <div className="bg-white_A700 flex flex-col gap-[18px] items-center justify-start p-[16px] rounded-radius15 shadow-bs2 w-[100%]">
                          <div className="flex flex-col items-center justify-start mt-[2px] md:w-[100%] sm:w-[100%] w-[46%]">
                            <Text
                              className="font-bold text-gray_900 text-left w-[auto]"
                              variant="body7"
                            >
                          ...
                          <Button
                            className="cursor-pointer font-medium leading-[normal] mb-[5px] text-[16px] text-center text-gray_400 w-[120px]"
                            shape="RoundedBorder10"
                            size="4xl"
                            variant="FillGray903"
                          >
                      ...
                      <div className="gap-[243px] md:gap-[40px] sm:gap-[40px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-center justify-between md:w-[100%] sm:w-[100%] w-[81%]">
                        <div className="bg-gradient4  border-bw3 border-solid border-white_A700 h-[25px] rounded-radius12 sm:w-[10px] md:w-[19px] w-[25px]"></div>
                        <div className="bg-gray_301 border-bw3 border-purple_50 border-solid h-[25px] rounded-radius12 sm:w-[10px] md:w-[19px] w-[25px]"></div>
                        <div className="bg-gray_302 border-bw3 border-purple_50 border-solid h-[25px] rounded-radius12 sm:w-[10px] md:w-[19px] w-[25px]"></div>
                        <div className="bg-gray_302 border-bw3 border-purple_50 border-solid h-[25px] rounded-radius12 sm:w-[10px] md:w-[19px] w-[25px]"></div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-col items-start justify-start md:w-[100%] sm:w-[100%] w-[89%]">
                <List
                  className="flex-col md:gap-[40px] sm:gap-[40px] gap-[949px] grid items-center w-[100%]"
                ...
                >
                  <div className="flex flex-1 flex-col items-center justify-start my-[0] w-[100%]">
                    <div className="flex flex-col gap-[16px] items-start justify-start w-[100%]">
                      ...
                      <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                        <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[12px] rounded-radius15 shadow-bs2 md:w-[100%] sm:w-[100%] w-[auto]">
                          <div className="flex flex-col gap-[10px] items-center justify-start my-[9px] md:w-[100%] sm:w-[100%] w-[98%]">
                            ...
                            >
                              ...
                              <span className="text-gray_900 text-[14px] font-poppins">
                                {" "}
                                Submit this link and wait for moderation
                                approval.
                              </span>
                            </Text>
                          </div>
                  ...
                  <div className="flex flex-1 flex-col items-center justify-start my-[0] w-[100%]">
                    <div className="flex flex-col gap-[15px] items-start justify-start w-[100%]">
                      <div className="flex flex-row gap-[13px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[2px] md:w-[100%] sm:w-[100%] w-[25%]">
                        <Text
                      ...
                      <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                        <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col items-center justify-start p-[18px] rounded-radius15 shadow-bs2 md:w-[100%] sm:w-[100%] w-[auto]">
                          <div className="flex flex-col gap-[10px] items-center justify-start my-[3px] md:w-[100%] sm:w-[100%] w-[99%]">
                            <div className="flex sm:flex-col flex-row gap-[27px] items-center justify-between w-[100%]">
                              <div className="flex sm:flex-1 flex-row gap-[5px] items-center justify-start sm:w-[100%] w-[auto]">
                                <Img
                                  src="images/img_send_blue_500.svg"
                                  className="h-[30px] w-[30px]"
                ...
                <div className="flex flex-row gap-[18px] items-center justify-start mt-[31px] w-[auto]">
                  <Text
                    className="font-bold text-gray_900 text-left w-[auto]"
                    variant="body1"
                  >
                ...
                <div className="flex flex-col items-center justify-start mt-[15px] md:w-[100%] sm:w-[100%] w-[50%]">
                  <div className="bg-white_A700 flex flex-col items-center justify-start p-[19px] rounded-radius15 shadow-bs2 w-[100%]">
                    <div className="flex flex-col gap-[10px] items-center justify-start my-[3px] md:w-[100%] sm:w-[100%] w-[99%]">
                      <div className="flex sm:flex-col flex-row gap-[28px] items-center justify-between w-[100%]">
                        <div className="flex sm:flex-1 flex-row gap-[5px] items-center justify-start sm:w-[100%] w-[auto]">
                          <Img
          ...
          <div className="absolute flex md:flex-col sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] inset-x-[0] items-start justify-between mx-[auto] top-[4%] w-[90%]">
                ...
                <div className="absolute bottom-[0] md:h-[388px] sm:h-[388px] h-[390px] left-[0] sm:w-[100%] w-[76%]">
                  ...
                  >
                    ...
                    <span className="text-gray_900 text-[20px] font-poppins">
                      ...
                      moderation and after approval your APR will boost to the
                      sky. Our program includes social tasks as reposts,
            ...
            <div className="flex flex-col items-center justify-start md:mt-[0] sm:mt-[0] mt-[14px] md:w-[100%] sm:w-[100%] w-[auto]">
              <div className="flex flex-col items-center justify-start w-[100%]">
        ...
        <div className="absolute bg-gradient4  h-[25px] left-[4%] md:px-[20px] sm:px-[20px] rounded-radius12 top-[10%] w-[25px]"></div>
        <Img
          src="images/img_rectangle89.png"
          className="absolute bottom-[26%] h-[489px] inset-x-[0] mx-[auto] object-cover rounded-radius15 w-[60%]"
        ...
        <div className="absolute bottom-[9%] flex flex-col inset-x-[0] items-center justify-start max-w-[1180px] mx-[auto] md:px-[20px] sm:px-[20px] w-[100%]">
          <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[65%]">
            ...
            <Text
              ...
              variant="body4"
            >
              You can watch our detailed tutorial if you have any troubles
            </Text>
            <Img
          ...
          <div className="flex flex-col gap-[15px] items-center justify-center mt-[30px] md:w-[100%] sm:w-[100%] w-[auto]">
            ...
            <div className="bg-white_A700 flex md:flex-col sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] items-center justify-between p-[16px] rounded-radius15 shadow-bs2 w-[100%]">
              <Text
                ...
                variant="body7"
              >
                Are there separate balance for different types of activity
                (pools, farm)?
              </Text>
              <Button
            ...
            <div className="bg-white_A700 flex md:flex-col sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] items-center justify-between p-[16px] rounded-radius15 shadow-bs2 w-[100%]">
              <Text
                ...
                variant="body7"
              >
                Are there fees for referral rewards withdrawal from referral
                balance?
              </Text>
              <Button
                className="flex h-[35px] items-center justify-center md:mt-[0] sm:mt-[0] my-[3px] w-[35px]"
...
export default ExtraBoostpagewithmorPage;
