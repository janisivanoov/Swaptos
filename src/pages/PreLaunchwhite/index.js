      ...
      <div className="bg-white_A700 flex flex-col font-inter gap-[9px] items-center justify-start mx-[auto] pb-[135px] w-[100%]">
        <div className="sm:h-[1240px] md:h-[680px] h-[760px] relative w-[100%]">
          ...
          <Img
            ...
            alt="Maskgroup"
          />
          <div className="absolute bottom-[25%] flex flex-col gap-[20px] items-start justify-start left-[6%] w-[56%]">
        ...
        <div className="flex flex-col font-poppins items-center justify-start max-w-[880px] mx-[auto] md:px-[20px] sm:px-[20px] w-[100%]">
...
export default PreLaunchwhitePage;
