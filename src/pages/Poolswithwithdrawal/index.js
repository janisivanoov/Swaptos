...
import { Img, Text, Button, Switch, Line, List } from "components";

const PoolswithwithdrawalPage = () => {
      ...
      <div className="font-poppins h-[3069px] mx-[auto] relative w-[100%]">
        <div className="bg-white_A700 flex flex-col h-[100%] items-center justify-start m-[auto] pb-[421px] w-[100%]">
          <div className="flex flex-col gap-[30px] items-center justify-start w-[100%]">
            <div className="sm:h-[1168px] h-[686px] md:h-[938px] relative w-[100%]">
              <div
                className="absolute bg-cover bg-no-repeat flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] pb-[150px] w-[100%]"
                style={{
              ...
              <div className="absolute bottom-[0] flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] inset-x-[0] items-center justify-start mx-[auto] w-[89%]">
            ...
            <div className="flex flex-col md:gap-[40px] sm:gap-[40px] gap-[60px] items-center justify-start max-w-[1180px] mx-[auto] md:px-[20px] sm:px-[20px] w-[100%]">
              <div className="flex md:flex-col sm:flex-col flex-row gap-[30px] items-start justify-between w-[100%]">
                <div className="flex md:flex-1 sm:flex-1 flex-col gap-[20px] items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                  <div className="bg-white_A700 flex h-[378px] md:h-[528px] sm:h-[528px] justify-end pt-[32px] sm:px-[20px] px-[32px] relative rounded-radius20 shadow-bs2 w-[100%]">
                  ...
                  <div className="bg-white_A700 flex h-[378px] md:h-[528px] sm:h-[528px] justify-end pt-[30px] sm:px-[20px] px-[30px] relative rounded-radius20 shadow-bs2 w-[100%]">
                ...
                <List
                  className="flex-col gap-[265px] md:gap-[40px] sm:gap-[40px] grid w-[auto]"
...
export default PoolswithwithdrawalPage;
